...
@section('content')
        ...
        <div class="apostil-form">
            <form id="createApostil" method="post" action="{{ ($documentId > 0) ? route('apostil.edit',$documentId) : route('apostil.submit') }}">
                {{csrf_field()}}
                    ...
                    <div class="row">
                        <div class="col-md-12 button-group">
                            <div class="row">
                                ...
                                <div class="col-md-3"><input class="apostil-nomresi" value="{{$apostilDocumentInfo->apostil_number ?? ''}}" name="apostil_number" placeholder="{{__('language.nomresi')}}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="text" maxlength="8" minlength="3">
                    ...
                    <div class="row">
                        <div class="col-md-12 button-group">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <select class="apostil-imzalayan-shexs" name="apostil_signing_user_id">
                                        @if(isset($apostilDocumentInfo->apostil_signing_user_id))
                                            <option selected value="{{ $apostilDocumentInfo->apostil_signing_user_id }}">{{ $apostilDocumentInfo->apostil_signing_user_name->name }}</option>
                                        @else
                                ...
                                <div class="col-md-3"><input name="mail_status" class="pocht" type="checkbox" {{ ($apostilDocumentInfo->mail_status ?? '') ? "checked" : "" }}></div>
                        ...
                        <div class="col-md-12 button-group">
                            <div class="row">
                                ...
                                <div class="col-md-9 metnDaxilEdin">
                                    <input class="apostil-qeyd" value="{{ $apostilDocumentInfo->apo_note ?? '' }}" name="apo_note" placeholder="{{__('language.metnDaxilEdin')}}" type="text">
                    ...
                    <div class="row">
                        <div class="col-md-12 button-group">
                            <div class="row">
                                <div class="col-md-3 bashliq"><h6>{{__('language.nomresi')}}</h6></div>
                                <div class="col-md-3">
                                    <input class="rs_nomresi" name="rs_number" placeholder="{{__('language.nomresi')}}" value="{{ $apostilDocumentInfo->rs_number ?? '' }}" type="number">
                    ...
                    <div class="row">
                        <div class="col-md-12 button-group">
                            <div class="row">
                                <div class="col-md-3 bashliq"><h6>{{__('language.imzalayanShexs')}}</h6></div>
                                <div class="col-md-3">
                                    <input name="rs_signing_user" class="rs_imzalayan_shexs" value="{{$apostilDocumentInfo->rs_signing_user ?? '' }}" placeholder="Ad Soyad" type="text">
                                ...
                                <div class="col-md-3">
                                    <input name="rs_signing_user_en" class="rs_imzalayan_shexs_en" value="{{$apostilDocumentInfo->rs_signing_user_en ?? '' }}" placeholder="Name Surname" type="text">
                    ...
                    <div class="row">
                        <div class="col-md-12 button-group">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input name="rs_signing_position" class="rs_vezife" value="{{$apostilDocumentInfo->rs_signing_position ?? '' }}" placeholder="{{__('language.vezife')}}" type="text">
                                ...
                                <div class="col-md-3">
                                    <input name="rs_signing_position_en" class="rs_vezife_en" value="{{$apostilDocumentInfo->rs_signing_position_en ?? '' }}" placeholder="{{__('language.position')}}" type="text">
                    ...
                    <div class="row">
                        <div class="col-md-12 button-group">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input name="rs_service" class="rs_veren_orqan"  value="{{$apostilDocumentInfo->rs_service ?? '' }}"  placeholder="{{__('language.verenOrqan')}}" type="text">
                                ...
                                <div class="col-md-3">
                                    <input name="rs_service_en" class="rs_veren_orqan_en" value="{{$apostilDocumentInfo->rs_service_en ?? '' }}" placeholder="{{__('language.givingAuthority')}}" type="text">
                    ...
                    <div class="row">
                        <div class="col-md-12 button-group">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input name="rs_document_name" class="rs_sened_ad" value="{{$apostilDocumentInfo->rs_document_name ?? '' }}" placeholder="{{__('language.senedinAdi')}}" type="text">
                                ...
                                <div class="col-md-3">
                                    <input name="rs_document_name_en" class="rs_sened_ad_en" value="{{$apostilDocumentInfo->rs_document_name_en ?? '' }}" placeholder="{{__('language.documentName')}}" type="text">
                    ...
                    <div class="row">
                        <div class="col-md-12 button-group">
                            <div class="row">
                                ...
                                <div class="col-md-9 metnDaxilEdin">
                                    <input name="rs_short_note" class="rs_qisa_mezmun" value="{{$apostilDocumentInfo->rs_short_note ?? '' }}" placeholder="{{__('language.metnDaxilEdin')}}" type="text">
                                ...
                                <div class="row content">
                                            ...
                                            <div class="col-md-9">
                                                <select class="qohumluq-derecesi" name="relationship_id">
                                                    @foreach($qohumluqDerecesi as $doc)
                                                        <option string_id="{{ $doc->string_id }}" value="{{ $doc->id }}">{{ $doc->name }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input name="doc_presented_tel" class="elaqeTelefonu" placeholder="{{__('language.nomreDaxilEdin')}}" type="number">
