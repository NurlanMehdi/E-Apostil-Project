...
class AllSelectBoxesSeeder extends Seeder
{
    ...
    public function run()
    {
        $selectBoxsValues = [
            ...
            ['name' => 'Təmsil edən şəxs (məktub əsasında)','novu'=>3,'string_id'=>'mektub_esasinda','key'=>'ishtirakchinin_novu'],
            ['name' => 'Səlahiyyətli şəxs','novu'=>3,'string_id'=>'selahiyyetli_shexs','key'=>'ishtirakchinin_novu'],
            ['name' => 'Pasport','novu'=>0,'string_id'=>'pasport','key'=>'senedin_tipi'],
            ['name' => 'Şəxsiyyət vəsiqəsi','novu'=>0,'string_id'=>'shexsiyyet_vesiqesi','key'=>'senedin_tipi'],
